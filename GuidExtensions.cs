...
namespace SecurityDriven
{
	...
	public static class GuidExtensions
	{
		...
		public static Guid FromBase64Url(string base64Url)
		{
			[DoesNotReturn]
			...
			*/
			...
			ReadOnlySpan<byte> decodeLookup = [
		...
		public static bool TryFromBase64Url(string base64Url, out Guid guid)
		{
			guid = default;

			if (base64Url is null || base64Url.Length != BASE64URL_LENGTH)
				return false;
